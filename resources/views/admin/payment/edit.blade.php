                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if (Auth::guard('artists')->check())
                                            <input type="text" class="form-control" placeholder="Artist Name" name="artist_name" value="{{ $payments->artist_name }}" readonly>
                                        @else
                                        <input type="text" class="form-control" placeholder="Artist Name" name="artist_name" value="{{ $payments->artist_name }}" >
                                        @endif
